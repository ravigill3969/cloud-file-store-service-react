              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-slate-600 max-w-md mx-auto leading-relaxed">
                    Support for single or bulk upload. Only upload files you have permission to share.
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-slate-600 text-sm">
                      {files.length} file{files.length !== 1 ? "s" : ""} • Total size: {getTotalSize()}
                    </p>
                  </div>
                  <button
        ...
        <div className="text-center mt-8">
          <div className="inline-flex items-center px-6 py-3 bg-slate-100/50 rounded-2xl border border-slate-200/50">
            <div className="text-slate-600 text-sm">
              ...
              <span className="font-medium ml-1">Supported formats:</span> JPEG, PNG, GIF
            </div>
          </div>
        </div>
      </div>
